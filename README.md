...
**Logos** (`assets/img/logos/*.svg`) : versions officielles récupérées sur Wikimedia Commons (Cisco, Fortinet, Microsoft Excel, ALTEN) et sur le site officiel huawei.com (Huawei, fleur + mot-symbole). Ce sont des marques déposées : elles sont affichées telles quelles pour indiquer les certifications obtenues et l'employeur, sans modification.
